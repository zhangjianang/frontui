package com.ang.frontui.sqlparse;
...
public class SqlParseTool {
    ...
    public static FromItem getFromItem(SelectBody selectBody) {
        if (selectBody instanceof PlainSelect) {
            ...
            SqlParseTool.getFromItem(((WithItem) selectBody).getSelectBody());
        }
        return null;
    }
    ...
    public static SubSelect getSubSelect(SelectBody selectBody) {
        if (selectBody instanceof PlainSelect) {
            ...
            SqlParseTool.getSubSelect(((WithItem) selectBody).getSelectBody());
        }
        return null;
    }
    ...
    public static void main(String[] args) throws JSQLParserException {
        ...
        SqlType sqlType = SqlParseTool.getSqlType(sql);
        if (sqlType.equals(SqlType.SELECT)) {
            Select statement = (Select) SqlParseTool.getStatement(sql);
            SubSelect subSelect = SqlParseTool.getSubSelect(statement.getSelectBody());
